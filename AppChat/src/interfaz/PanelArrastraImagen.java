...
public class PanelArrastraImagen extends JDialog {
	...
	public PanelArrastraImagen(JFrame owner) {
		...
		JLabel titulo = new JLabel(
				"<html><h2>Agregar Foto</h2><div>Puedes arrastrar la imagen aquí o seleccionarla de tu ordenador.</div></html>");
		...
		botonElegir.addActionListener(e -> {
			...
			chooser.setFileFilter(
					new javax.swing.filechooser.FileNameExtensionFilter("Imágenes", "jpg", "jpeg", "png", "gif"));
