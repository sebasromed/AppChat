...
public class VentanaLogin extends JFrame implements ActionListener {
	...
	private void panelTitulo() {
		...
		lblNorte = new JLabel("AppChat") {
			...
			protected void paintComponent(Graphics g) {
				...
				g2.setColor(Controlador.VERDE_MEDIO);
	...
	private void panelCentro() {
		...
		panelCentro.setBorder(new TitledBorder(
				new CompoundBorder(new EmptyBorder(0, 30, 0, 30), new LineBorder(Controlador.VERDE_MEDIO, 2)), "Login",
				TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION,
				new Font("Comic Sans MS", Font.BOLD, 16), Controlador.VERDE_MEDIO));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src == aceptar) {
			...
			if (Controlador.INSTANCE.loginUsuario(tlf, passw)) {
				...
				JOptionPane.showMessageDialog(this, "Teléfono o contraseña incorrectos.", "Error",
						JOptionPane.ERROR_MESSAGE);
			}
